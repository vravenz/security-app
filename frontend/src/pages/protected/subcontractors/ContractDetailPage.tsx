...
const ContractDetailPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchContractDetail = async () => {
            try {
                const response = await axios.get(`http://localhost:4000/api/subcontractors/contract/${contractId}`);
    ...
    const handleAddEmployeeRequest = async () => {
        ...
        try {
            const response = await axios.post(`http://localhost:4000/api/subcontractors/employee-request`, {
    ...
    const handleViewApplicants = async (requestId: number) => {
        ...
        try {
            const response = await axios.get(`http://localhost:4000/api/subcontractors/requests/${requestId}/applicants`);
    ...
    const handleUpdateApplicantStatus = async (applicantId: number, newStatus: string) => {
        try {
            const response = await axios.post(`http://localhost:4000/api/subcontractors/applicant-status-update`, {
                applicantId,
                status: newStatus,
