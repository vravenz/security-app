...
const ApplicationDetailsPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchApplicationDetails = async () => {
            const response = await fetch(`http://localhost:4000/api/applicants/details/${applicationId}`);
            if (response.ok) {
                ...
                <div className="space-y-8">
                    ...
                    {application.employee_photo && (
                        <div className="flex justify-center">
                            <img
                                src={`http://localhost:4000/uploads/employee-photos/${application.employee_photo}`}
                                alt="Employee Photo"
