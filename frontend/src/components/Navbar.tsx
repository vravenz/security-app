...
import {
    FaBars, FaTimes, FaHome, FaUsers, FaCalendar, FaChartPie, FaBuilding,
    FaCoffee, FaMapMarkerAlt, FaFileInvoiceDollar
} from 'react-icons/fa';
    ...
    return (
        <Card className={`sticky top-0 shadow-md z-50 relative ${backgroundColorClass} ${textColorClass}`}>
            <div className="container-fluid mx-auto px-4 flex justify-between items-center">
                <Link to="/dashboard" className="text-lg font-bold">KFMG</Link>
